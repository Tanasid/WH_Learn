<div class="container-fluid">
    ...
    <div class="row d-flex justify-content-between my-3">
        <div class="col-md-12 mx-auto">
            <label class="h3 mb-2 text-gray-800" for="">Manage Permission</label>
            <div class="d-flex">
                <select type="text" class="form-select mr-md-5 col-md-6" id="selGroup"></select>
    ...
    <div class="row d-flex justify-content-between">
        <div class="my-3">
            <h1 class="h3 mb-2 text-gray-800">Register Permission</h1>
        </div>
        <div class="col-md-6 mx-auto">
            <label class="fs-4" for="">Menu Group Name</label>
            <select type="text" class="form-select" id="selMenuGroupName" disabled>
                <option value="">Please Select Menu Name ...</option>
            </select>
        </div>
        <div class="col-md-6 mx-auto">
            <label class="fs-4" for="">Sub Menu Name</label>
            <div class="d-flex">
                <select type="text" class="form-select mr-md-5 col-md-6l" id="selSubMenuName" disabled>
                    <option value="">Please Select Sub Menu Name ...</option>
                </select>
                <button class="btn btn-success px-3" id="btnSaveAddPer">Add</button>
            </div>
        </div>
    </div>
